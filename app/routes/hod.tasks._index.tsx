            ...
            <div>
                <div className="z-1">
                    ...
                    <div className="grid grid-cols-4 mt-4 gap-8">
                        {tasks?.map((task: TaskInterface, index: number) => (
                            <div
                                className="h-[14vw] border bg-default-100 w-full rounded-xl dark:border-default-200 p-2"
                                key={index}
                            >
                                <div>
                                    <Button
                                ...
                                <p className="mt-2 text-xs font-nunito">{task.description}</p><hr className="border dark:border-default-200 border-1 mt-10" />
                ...
                >
                    <div className="flex gap-40">
                        ...
                        <button onClick={ViewcommentDrawer}>
                            <CloseIcon className="h-4 w-4" />
                        </button>
                    </div><hr className="mt-4 border border-default-400" />
