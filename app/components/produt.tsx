            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-20">
                    {[
                        ...
                        < CardContainer
                            key={i}
                            className="inter-var group overflow-hidden border-border/40  backdrop-blur transition-all hover:border-border hover:bg-background/80 !bg-[#09090B80]"
                        >
                            <CardBody className="!bg-[#09090B80 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-20 sm:w-[30rem] h-auto rounded-xl p-6 border  ">
